...
<div class="pt-2 bg-[#F6F8FF]">
  ...
  <div class="flex justify-center items-center mt-10 bg-[#F6F8FF]">
    <div class="relative bg-white border-grey mt-3 lg:w-300 md:w-175 sm:w-150 w-75 rounded-xl flex justify-center items-center shadow-2xl h-100 ">
    <div class="flex justify-between">
      <div class="absolute lg:top-8 lg:left-4 top-4 left-2 flex items-center gap-3 p-2">
        <div class="flex items-center justify-start gap-2 bg-[#1A5A9E] rounded-sm text-[Inter] font-semibold text-white p-1 px-1.5 w-fit cursor-pointer">
      ...
      <div class="absolute lg:top-8 lg:right-5 top-16 right-12.5 flex items-center gap-10 p-2 md:hidden">
           <button class="text-[#1A5A9E] font-bold text-lg cursor-pointer">Select</button>
      ...
      <!-- Desktop-->
      <div class="absolute lg:top-8 lg:right-5 top-4 right-5 flex items-center gap-8 p-2">
        <div class="  flex items-center justify-start gap-10">
          ...
          <div class="flex justify-between items-center gap-2 lg:top-8 lg:right-4 top-4 right-2">
            <span class="text-xs lg:text-lg md:text-md sm:text-sm whitespace-nowrap">1-x of x</span>
