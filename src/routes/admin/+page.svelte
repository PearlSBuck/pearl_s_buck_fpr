...
<script lang="ts">
  ...
  import Year from '../../components/Year.svelte'; // adjust the path as needed
  import Confirm from '../../components/Confirm.svelte'; // adjust the path as needed

  let pageName = "rinaldo baldcado";
  let innerText = "Year: 2023";
